    ...
    <div className="flex flex-col items-center justify-start min-h-screen bg-background py-8 main-container">
      <div className="max-w-lg w-full space-y-6">
        ...
        <div className="bg-card rounded-xl p-6 shadow-sm mt-6">
          ...
          <p><strong>* Pep talk history is just for you!</strong> Your past pep talks are stored locally on your computer in local storage. This means they are private and only accessible from your device.</p>
          ...
          <ol>
            ...
            <li>Under "Storage", find and clear your local storage.</li>
